      ...
      <div className='bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 h-full flex flex-col'>
        ...
        <div className='relative overflow-hidden flex-shrink-0'>
          ...
          <button
            ...
            disabled={toggling}
            className='absolute top-3 right-3 w-9 h-9 rounded-full bg-white shadow-md flex items-center justify-center hover:scale-110 transition-transform disabled:opacity-70 disabled:cursor-not-allowed'
          >
            {toggling ? (
