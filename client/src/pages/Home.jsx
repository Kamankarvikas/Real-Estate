      ...
      <div className='bg-red-600 text-white py-2.5 border-b border-red-700'>
        <div className='marquee-wrapper'>
          <div className='marquee-track'>
            <span className='flex items-center gap-3 px-6 text-sm font-semibold shrink-0 whitespace-nowrap'>
              <svg className='w-4 h-4 shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z' />
              </svg>
              Server down for maintenance — some features may be temporarily unavailable. We'll be back soon!
            </span>
            <span className='flex items-center gap-3 px-6 text-sm font-semibold shrink-0 whitespace-nowrap'>
              <svg className='w-4 h-4 shrink-0' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z' />
