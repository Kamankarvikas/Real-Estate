    ...
    <div>
      ...
      <div className='max-w-6xl mx-auto px-6 py-20'>
        <div className='grid lg:grid-cols-2 gap-16'>
          <div>
            <p className='text-blue-600 text-xs font-semibold uppercase tracking-widest mb-2'>Our Story</p>
          ...
          <div>
            <p className='text-blue-600 text-xs font-semibold uppercase tracking-widest mb-2'>Our Promise</p>
      ...
      <div className='bg-gray-50'>
        <div className='max-w-6xl mx-auto px-6 py-20'>
          <div className='text-center mb-14'>
            <p className='text-blue-600 text-xs font-semibold uppercase tracking-widest mb-2'>What We Offer</p>
      ...
      <div className='max-w-6xl mx-auto px-6 py-20'>
        <div className='text-center mb-14'>
          <p className='text-blue-600 text-xs font-semibold uppercase tracking-widest mb-2'>Meet The Founder</p>
        ...
        <div className='max-w-2xl mx-auto bg-white rounded-2xl border border-gray-100 shadow-md overflow-hidden'>
          ...
          <div className='px-8 pb-8 -mt-10'>
            {/* Avatar */}
            <div className='w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center text-white text-2xl font-bold border-4 border-white shadow-lg'>
              VK
            </div>
            <h3 className='text-xl font-bold text-slate-800 mt-4'>Vikas Kamankar</h3>
            <p className='text-sm text-blue-600 font-medium mb-4'>Founder & Owner</p>
      ...
      <div className='bg-slate-900'>
        <div className='max-w-6xl mx-auto px-6 py-16 text-center'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <Link
              to='/search'
              className='inline-block bg-blue-600 text-white font-semibold px-8 py-3.5 rounded-lg hover:bg-blue-700 transition-colors text-sm'
            >
              Explore Properties
            </Link>
            <a
